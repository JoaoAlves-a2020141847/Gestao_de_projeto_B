...
<body>
    <form method="POST" action="mainReserva.php">
        ...
        <br>
        <input type="checkbox" name="dia[]" value="2">
        <label for="dia2">dia 2 6€</label>
        <br>
        <input type="checkbox" name="dia[]" value="3">
        <label for="dia3">dia 3 5€</label>
        <br>
        <input type="checkbox" name="dia[]" value="4">
        <label for="dia4">dia 4 180€</label>
        <br>
        <input type="checkbox" name="dia[]" value="5">
        ...
        <input type="button" name="button" value="Mostrar listas" onclick="location.href='./mainReserva.php'">
